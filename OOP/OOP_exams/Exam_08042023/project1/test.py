from project1.robots_managing_app import RobotsManagingApp

main_app = RobotsManagingApp()
print(main_app.add_service('SecondaryService', ''))
print(main_app.add_service('SecondaryService', ''))

print(main_app.add_service('MainService', 'ServiceTechnicalsWorld'))

print(main_app.services[0].capacity)
print(main_app.services[1].capacity)
print(main_app.services[0].details())
print(main_app.services[1].details())
