...
from project1.horse_race_app import HorseRaceApp

horseRaceApp = HorseRaceApp()
print(horseRaceApp.add_horse("Appaloosa", "Spirit", 120))
print(horseRaceApp.add_horse("Thoroughbred", "Rocket", 140))
print(horseRaceApp.horses[0].speed)
print(horseRaceApp.horses[1].speed)
print(horseRaceApp.horses[0].train())
print(horseRaceApp.horses[1].train())
print(horseRaceApp.add_horse("Appaloosa1", "Spirit", 120))
